...
source build_scripts/build/ncurses.sh "ncurses-${config_tools_list__ncurses__version}.tar.xz"
source build_scripts/build/bash.sh "bash-${config_tools_list__bash__version}.tar.xz"
...
source build_scripts/build/file.sh "file-${config_tools_list__file__version}.tar.xz"
...
source build_scripts/build/make.sh "make-${config_tools_list__make__version}.tar.xz"
