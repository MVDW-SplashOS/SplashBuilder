...
bash -e /splash_builder/gdbm.sh "gdbm-${config_tools_list__gdbm__version}.tar.xz"
bash -e /splash_builder/gperf.sh "gperf-${config_tools_list__gperf__version}.tar.xz"
...
bash -e /splash_builder/less.sh "less-${config_tools_list__less__version}.tar.xz"
bash -e /splash_builder/perl-pass-2.sh "perl-${config_tools_list__perl__version}.tar.xz"
bash -e /splash_builder/xmlparser.sh "xml_parser-${config_tools_list__xml_parser__version}.tar.xz"
bash -e /splash_builder/intltool.sh "intltool-${config_tools_list__intltool__version}.tar.xz"
...
bash -e /splash_builder/openssl.sh "openssl-${config_tools_list__openssl__version}.tar.xz"
bash -e /splash_builder/kmod.sh "kmod-${config_tools_list__kmod__version}.tar.xz"
bash -e /splash_builder/libelf.sh "elfutils-${config_tools_list__elfutils__version}.tar.xz"
bash -e /splash_builder/libffi.sh "libffi-${config_tools_list__libffi__version}.tar.xz"
bash -e /splash_builder/python-pass-2.sh "python-${config_tools_list__python__version}.tar.xz"
bash -e /splash_builder/wheel.sh "wheel-${config_tools_list__wheel__version}.tar.xz"
bash -e /splash_builder/ninja.sh "ninja-${config_tools_list__ninja__version}.tar.xz"
bash -e /splash_builder/meson.sh "meson-${config_tools_list__meson__version}.tar.xz"
bash -e /splash_builder/coreutils.sh "coreutils-${config_tools_list__coreutils__version}.tar.xz"
bash -e /splash_builder/check.sh "check-${config_tools_list__check__version}.tar.xz"
...
bash -e /splash_builder/groff.sh "groff-${config_tools_list__groff__version}.tar.xz"
...
bash -e /splash_builder/libpipeline.sh "libpipeline-${config_tools_list__libpipeline__version}.tar.xz"
bash -e /splash_builder/make.sh "make-${config_tools_list__make__version}.tar.xz"
...
bash -e /splash_builder/markupsafe.sh "markupsafe-${config_tools_list__markupsafe__version}.tar.xz"
bash -e /splash_builder/jinja2.sh "jinja2-${config_tools_list__jinja2__version}.tar.xz"
bash -e /splash_builder/systemd.sh "systemd-${config_tools_list__systemd__version}.tar.xz"
bash -e /splash_builder/dbus.sh "dbus-${config_tools_list__dbus__version}.tar.xz"
bash -e /splash_builder/mandb.sh "man_db-${config_tools_list__man_db__version}.tar.xz"
bash -e /splash_builder/procpsng.sh "procps_ng-${config_tools_list__procps_ng__version}.tar.xz"
bash -e /splash_builder/utillinux-pass-2.sh "util_linux-${config_tools_list__util_linux__version}.tar.xz"
bash -e /splash_builder/e2fsprogs.sh "e2fsprogs-${config_tools_list__e2fsprogs__version}.tar.xz"
bash -e /splash_builder/neofetch.sh "neofetch-${config_tools_list__neofetch__version}.tar.xz"
