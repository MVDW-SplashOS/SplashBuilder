...
bash -e /splash_builder/utillinux-pass-1.sh "util_linux-${config_tools_list__util_linux__version}.tar.xz"
bash -e /splash_builder/cleanup.sh


# Building final tools
bash -e /splash_builder/bas.sh #TODO: Finish the BAS package manager 
bash -e /splash_builder/manpages.sh "man_pages-${config_tools_list__man_pages__version}.tar.xz"
bash -e /splash_builder/ianaetc.sh "iana_etc-${config_tools_list__iana_etc__version}.tar.xz"
...
bash -e /splash_builder/bzip2.sh "bzip2-${config_tools_list__bzip2__version}.tar.xz"
bash -e /splash_builder/xz.sh "xz-${config_tools_list__xz__version}.tar.xz"
bash -e /splash_builder/zstd.sh "zstd-${config_tools_list__zstd__version}.tar.xz"
bash -e /splash_builder/file.sh "file-${config_tools_list__file__version}.tar.xz"
bash -e /splash_builder/readline.sh "readline-${config_tools_list__readline__version}.tar.xz"
...
bash -e /splash_builder/flex.sh "flex-${config_tools_list__flex__version}.tar.xz"
bash -e /splash_builder/tcl.sh "tcl-${config_tools_list__tcl__version}.tar.xz"
bash -e /splash_builder/expect.sh "expect-${config_tools_list__expect__version}.tar.xz"
bash -e /splash_builder/dejagnu.sh "dejagnu-${config_tools_list__dejagnu__version}.tar.xz"
...
bash -e /splash_builder/mpc.sh "mpc-${config_tools_list__mpc__version}.tar.xz"
bash -e /splash_builder/attr.sh "attr-${config_tools_list__attr__version}.tar.xz"
...
bash -e /splash_builder/pkgconfig.sh "pkg_config-${config_tools_list__pkg_config__version}.tar.xz"
bash -e /splash_builder/ncurses.sh "ncurses-${config_tools_list__ncurses__version}.tar.xz"
...
bash -e /splash_builder/bash.sh "bash-${config_tools_list__bash__version}.tar.xz"
