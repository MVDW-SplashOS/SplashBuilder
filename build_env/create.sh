...
bash -e build_scripts/binutils-pass-1.sh binutils-2.38.tar.xz
bash -e build_scripts/gcc-pass-1.sh gcc-11.2.0.tar.xz
...
bash -e build_scripts/binutils-pass-2.sh binutils-2.38.tar.xz
